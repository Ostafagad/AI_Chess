...
text = font.render('AIProject', True, red, darkgoldenrod1)
text1 = font.render('AI', True, red)
text2 = font.render('player2', True, red)
text3 = font.render('Black won by checkmate', True, red)
text4 = font.render('White won by checkmate', True, red)
text5 = font.render('stalemate', True, red)
...
while not quitgame:
    for event in pygame.event.get():
        ...
        pygame.draw.rect(gamedisplay, (238, 201, 0), [100, 300, 200, 100])
        gamedisplay.blit(text1, textRect1)
        pygame.draw.rect(gamedisplay, (238, 201, 0), [500, 300, 200, 100])
        ...
        for column in range(8):
            if color % 2 == 0:
                ...
                if not chessBoard.gameTiles[rows][column].pieceonTile.tostring() == "-":
                    ...
                    allpieces.append(
                        [img, [xpos, ypos], chessBoard.gameTiles[rows][column].pieceonTile])
        ...
        for event in pygame.event.get():
                ...
                for x in range(8):
                    for y in range(8):
                        if chessBoard.gameTiles[y][x].pieceonTile.alliance == 'Black' and turn % 2 == 1:
                            moves1 = chessBoard.gameTiles[y][x].pieceonTile.legalmoveb(
                                chessBoard.gameTiles)
                            lx1 = movex.pinnedb(
                                chessBoard.gameTiles, moves1, y, x)
                            if len(lx1) == 0:
                                continue
                            else:
                                check = True
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if movex.checkw(chessBoard.gameTiles)[0] == 'checked' and len(moves) == 0:
                    ...
                    imgx = pygame.transform.scale(pygame.image.load(
                        "./chessart/red_square.png",), (100, 100))
                    mx = []
                    ma = []
                    for move in array:
                    ...
                    if chessBoard.gameTiles[promote[5][0]][promote[5][1]].pieceonTile.alliance == 'Black':
                        for i in range(len(promote)):
                            ...
                            if promote[i][0] == n and promote[i][1] == m:
                                if i == 0:
                                    chessBoard.gameTiles[promote[4][1]][promote[4][0]].pieceonTile = queen(
                                        'Black', updateposition(promote[4][1], promote[4][0]))
                                    chessBoard.gameTiles[promote[5][0]][promote[5][1]].pieceonTile = nullpiece(
                                    )
                                    break
                                if i == 1:
                                    chessBoard.gameTiles[promote[4][1]][promote[4][0]].pieceonTile = rook(
                                        'Black', updateposition(promote[4][1], promote[4][0]))
                                    chessBoard.gameTiles[promote[5][0]][promote[5][1]].pieceonTile = nullpiece(
                                    )
                                    break
                                if i == 2:
                                    chessBoard.gameTiles[promote[4][1]][promote[4][0]].pieceonTile = knight(
                                        'Black', updateposition(promote[4][1], promote[4][0]))
                                    chessBoard.gameTiles[promote[5][0]][promote[5][1]].pieceonTile = nullpiece(
                                    )
                                    break
                                if i == 3:
                                    chessBoard.gameTiles[promote[4][1]][promote[4][0]].pieceonTile = bishop(
                                        'Black', updateposition(promote[4][1], promote[4][0]))
                                    chessBoard.gameTiles[promote[5][0]][promote[5][1]].pieceonTile = nullpiece(
                                    )
                                    break
                    ...
                    if chessBoard.gameTiles[promote[5][0]][promote[5][1]].pieceonTile.alliance == 'White':
                        for i in range(len(promote)):
                            ...
                            if promote[i][0] == n and promote[i][1] == m:
                                if i == 0:
                                    chessBoard.gameTiles[promote[4][1]][promote[4][0]].pieceonTile = queen(
                                        'White', updateposition(promote[4][1], promote[4][0]))
                                    chessBoard.gameTiles[promote[5][0]][promote[5][1]].pieceonTile = nullpiece(
                                    )
                                    break
                                if i == 1:
                ...
                if not len(moves) == 0:
                    ...
                    for move in moves:
                        if move[0] == n and move[1] == m:
                            ...
                            if chessBoard.gameTiles[y][x].pieceonTile.tostring() == 'K' and m == x+2:
                                chessBoard.gameTiles[y][x +
                                                        1].pieceonTile = chessBoard.gameTiles[y][x+3].pieceonTile
                                s = updateposition(y, x+1)
                                chessBoard.gameTiles[y][x +
                                                        1].pieceonTile.position = s
                                chessBoard.gameTiles[y][x +
                                                        3].pieceonTile = nullpiece()
                            if chessBoard.gameTiles[y][x].pieceonTile.tostring() == 'K' and m == x-2:
                                chessBoard.gameTiles[y][x -
                                                        1].pieceonTile = chessBoard.gameTiles[y][0].pieceonTile
                                s = updateposition(y, x-1)
                                chessBoard.gameTiles[y][x -
                                                        1].pieceonTile.position = s
                    ...
                    if promotion == True:
                        if chessBoard.gameTiles[y][x].pieceonTile.tostring() == 'P' and x == 7 and y == 6:
                            pygame.draw.rect(gamedisplay, (255, 255, 255), [
                                             x*100-100, (y*100)-200, 200, 200])
                            imgx = pygame.transform.scale(
                                pygame.image.load("./chessart/BQ.png",), (100, 100))
                            imgx1 = pygame.transform.scale(
                                pygame.image.load("./chessart/BR.png",), (100, 100))
                            imgx2 = pygame.transform.scale(
                                pygame.image.load("./chessart/BN.png",), (100, 100))
                            imgx3 = pygame.transform.scale(
                                pygame.image.load("./chessart/BB.png",), (100, 100))
                            ...
                            promote = [[y-2, x], [y-2, x+1],
                                       [y-1, x], [y-1, x+1], [m, n], [y, x]]

                        elif chessBoard.gameTiles[y][x].pieceonTile.tostring() == 'p' and x == 7 and y == 1:
                            pygame.draw.rect(gamedisplay, (0, 0, 0), [
                                             x*100-100, (y*100)+100, 200, 200])
                            imgx = pygame.transform.scale(
                                pygame.image.load("./chessart/WQ.png",), (100, 100))
                            imgx1 = pygame.transform.scale(
                                pygame.image.load("./chessart/WR.png",), (100, 100))
                            imgx2 = pygame.transform.scale(
                                pygame.image.load("./chessart/WN.png",), (100, 100))
                            imgx3 = pygame.transform.scale(
                                pygame.image.load("./chessart/WB.png",), (100, 100))
                            gamedisplay.blit(imgx, [x*100-100, (y*100)+200])
                            gamedisplay.blit(imgx1, [(x*100), (y*100)+200])
                            gamedisplay.blit(imgx2, [x*100-100, (y*100)+100])
                            gamedisplay.blit(imgx3, [(x*100), (y*100)+100])
                    ...
                    if (not chessBoard.gameTiles[y][x].pieceonTile.tostring() == '-'):
                        moves = chessBoard.gameTiles[y][x].pieceonTile.legalmoveb(
                            chessBoard.gameTiles)
        ...
        for event in pygame.event.get():
            ...
            if not turn % 2 == 0 and promotion == False:
                ...
                if promotion == True:
                    ...
                    if chessBoard.gameTiles[y][x].pieceonTile.tostring() == 'P':
                        chessBoard.gameTiles[y][x].pieceonTile = nullpiece()
                        chessBoard.gameTiles[n][m].pieceonTile = queen(
                            'Black', updateposition(n, m))
                        allTiles.clear()
                        allpieces.clear()
                        chessBoard.printboard()
                        drawchesspieces()
